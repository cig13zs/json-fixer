# JSON Fixer Online — Repair Malformed JSON Syntax Errors

> Repair broken JSON online for free. Fix unquoted keys, single quotes, trailing commas, comments, and Python True/False values 100% client-side.

[![Live Web App](https://img.shields.io/badge/Web_App-Live_Demo-3B82F6?style=flat-square)](https://cig13zs.github.io/json-fixer/)
[![Chrome Extension](https://img.shields.io/badge/Chrome_Extension-Manifest_V3-10B981?style=flat-square)](https://github.com/cig13zs/json-fixer/releases)
...
- **Dual Delivery:** Use directly in your browser at [https://cig13zs.github.io/json-fixer/](https://cig13zs.github.io/json-fixer/) or install the offline Chrome Extension package.
...
Paste your invalid JSON into the input editor. JSON Fixer intelligently identifies and repairs syntax mistakes, unquoted properties, single quotes, and trailing commas.
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/cig13zs/json-fixer.git
   ```
